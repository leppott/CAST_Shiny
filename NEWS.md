...
- docs: Post-merge version number update
...
- function: Estimate report time
  - Add timing variables to global
  - Add estimate to Run Report tab
  - Add estimate and inputs to report complete shiny alert
